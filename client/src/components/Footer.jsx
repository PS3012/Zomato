...
function Footer() {
     return (
          <>
               ...
               <footer className="relative bg-blueGray-200 pt-8 pb-6 border-t bg-slate-100">
                              ...
                              <div className="w-full lg:w-6/12 px-4">
                                   <div className="flex flex-wrap items-top mb-6">
                                        <div className="w-full lg:w-4/12 px-4 ml-auto">
                                             <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2 text-red-600">Useful Links</span>
                                        ...
                                        <div className="w-full lg:w-4/12 px-4">
                                             <span className="block uppercase text-blueGray-500 text-sm font-semibold mb-2 text-red-600">Other Resources</span>
                                             <ul className="list-unstyled">
                                                  <li>
                         ...
                         <div className="flex flex-wrap items-center md:justify-between justify-center">
                              <div className="w-full md:w-4/12 px-4 mx-auto text-center">
                                   <div className="text-sm text-blueGray-500 font-semibold py-1">
                                        ...
                                        <a href="https://www.creative-tim.com?ref=njs-profile" className="text-blueGray-500 hover:text-blueGray-800">Piyush Sahu</a>.
                                   </div>
                              </div>
                         </div>
                    </div>
